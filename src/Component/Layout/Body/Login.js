                        ...
                        <div class="row d-flex">
                            <div class="col-lg-6">
                                <div class="card1 pb-5">
                                    ...
                                    <div class="row px-3 justify-content-center mt-4 mb-5 border-line"> <figure><img src="image/signin-image.jpg" alt="sing up image" /></figure></div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="card2 card border-0 px-4 py-5">
                                    ...
                                    </label> <input class="mb-4" type="text" name="email" class="form-rounded" placeholder="Enter e-mail address" value={this.state.email} name="email" onChange={this.inputHandler} required/> </div>
                                    <div class="row px-3"> <label class="mb-1">
